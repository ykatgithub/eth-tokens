...
import MyToken from "./contracts/Token.json";
import MyTokenSale from "./contracts/GHMCTokenSale.json";
...
class App extends Component {
  ...
  render() {
    ...
    return (
      <div className="App">
        <h1>GHMC Assets  - Token Sale</h1>
        <p>Purchase your asset at low price by purchasing tokens today!</p>
        <h2>Register for Sale</h2>
        Register with your Address(public key) to participate: <input type="text" name="kycAddress" value={this.state.kycAddress} onChange={this.handleInputChange} />
        <button type="button" onClick={this.handleKycWhitelisting}>Add to Whitelist</button>
        <h2>Buy Tokens</h2>
        <p>If you want to buy tokens, send Wei to this address: {this.state.tokenSaleAddress}</p>
        <p>You currently have: {this.state.userTokens} GHMC Tokens</p>
